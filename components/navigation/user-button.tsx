        ...
        <DropdownMenu modal={false}>
          ...
          <DropdownMenuContent align="end" className="p-4">
            ...
            <DropdownMenuItem className="cursor-pointer group hover:bg-primary/10">
              <Truck className="w-5 h-5 mr-3 group-hover:translate-x-1 group-hover:text-black transition-all duration-300 ease-in-out" />
              <span className="text-sm font-medium">My Orders</span>
            </DropdownMenuItem>
            <DropdownMenuItem
              className="cursor-pointer group hover:bg-primary/10"
              onClick={() => router.push("/setting-dashboard/settings")}
            >
              <Settings className="w-5 h-5 mr-3 group-hover:rotate-180 group-hover:text-black transition-all duration-300 ease-in-out" />
