...
export const EmailComfirimationTemplate = ({
  ...
  return (
    <Html>
      <Head />
      <Preview>Confirm Your Account - Welcome to Genini</Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Section>
            ...
            <Text style={text}>
              Welcome to Genini! We're excited to have you on board.Please
            ...
            <Text style={text}>Thanks, The Genini Team</Text>
          </Section>
        </Container>
      </Body>
    </Html>
